...
void GPU_Geometry::setTextures(const std::vector<glm::vec2>& textures) {
	textureBuffer.uploadData(sizeof(glm::vec2) * textures.size(), textures.data(), GL_STATIC_DRAW);
}
